...
$P(B|A_1,I) > P(B|A_j,I)$
Then $A_1$ is considered best explanation for B and is provisionally accepted
Hence,
...
$P(A_k|B) = \frac{P(B|A_k).P(A_k)}{P(B|A_k).P(A_k)+P(B|A_j).P(A_j)+P(B|A_i).P(A_i)+P(B|\overline A)(1-[P(A_k)+P(A_j)+P(A_i)])}$

$P(A_1|B) = \frac{0.2X0.002}{(0.2X0.002)+(0.1X0.003)+(0.02X0.01)+(0.001)(1-[0.002+0.003+0.01])}$ = 21.220%

$P(A_2|B) = \frac{0.1X0.003}{(0.2X0.002)+(0.1X0.003)+(0.02X0.01)+(0.001)(1-[0.002+0.003+0.01])}$ = 15.915%

$P(A_3|B) = \frac{0.02X0.01}{(0.2X0.002)+(0.1X0.003)+(0.02X0.01)+(0.001)(1-[0.002+0.003+0.01])}$ = 10.610%

$$P(\overline A|B) = 
\frac{P(B|\overline A).P(\overline A)}{P(B|A_k).P(A_k)+P(B|A_j).P(A_j)+P(B|A_i).P(A_i)+P(B|\overline A)(P(\overline A))} =
\frac{0.001X(1-[0.002+0.003+0.01])}{(0.2X0.002)+(0.1X0.003)+(0.02X0.01)+(0.001)(1-[0.002+0.003+0.01])}$$ = 52.631%

###1b-ii
Since, $P(\overline A | B) > P(A_1|B) > P(A_2|B) > P(A_3|B)$
Then $\overline A$ is considered best explanation (Having no disease) for the symptoms and is provisionally accepted.
...
= \frac{(\lambda.t.5)^r.e^{-\lambda.t.5}}{r!}
=\frac{(30.2.5)^{380}e^{-30.2.5}}{380!} = 1.103 X 10^{-6} \\
L(\lambda = 50,r=380,t=2)
= \frac{(50.2.5)^{380}e^{-50.2.5}}{380!} = 3.0645 X10^{-9}
$$   

Therefore,
$$
L(\lambda = 40,r=380,t=2)= \frac{(40.2.5)^{380}e^{-40.2.5}}{380!} = 1.23 X 10^{-2}
$$

Posterior probabilties:
$$
P(\lambda|r=380,t=2)=\frac{\frac{(2\lambda.5)^{380}e^{-2\lambda.5}}{380!}.P(\lambda)}{\sum(LiklihoodsXP(\lambda))}
$$
The $\lambda^r$ terms cancel out

$$
P(\lambda=30|r=380,t=2) = \frac{((30.2.5)^{380}e^{-30.2.5})\frac{1}{4}}{((30.2.5)^{380}e^{-30.2.5}.\frac{1}{4})
+((40.2.5)^{380}e^{-40.2.5}.\frac{1}{2})
+((50.2.5)^{380}e^{-50.2.5}.\frac{1}{4})} \\
= 4.475X10^{-5}
$$
$$
P(\lambda=40|r=380,t=2) = \frac{((40.2.5)^{380}e^{-40.2.5})\frac{1}{2}}{((30.2.5)^{380}e^{-30.2.5}.\frac{1}{4})
+((40.2.5)^{380}e^{-40.2.5}.\frac{1}{2})
+((50.2.5)^{380}e^{-50.2.5}.\frac{1}{4})} \\ 
= 0.999
$$
$$
P(\lambda=50|r=380,t=2) = \frac{((50.2.5)^{380}e^{-50.2.5})\frac{1}{4}}{((30.2.5)^{380}e^{-30.2.5}.\frac{1}{4})
+((40.2.5)^{380}e^{-40.2.5}.\frac{1}{2})
+((50.2.5)^{380}e^{-50.2.5}.\frac{1}{4})} \\ 
= 1.2458X10^{-7}
$$
...
prior density:
$$p(\theta|\alpha_1,...,\alpha_k,\alpha_{k+1})$$ 
